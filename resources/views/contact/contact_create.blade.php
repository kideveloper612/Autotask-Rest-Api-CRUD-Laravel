    ...
    <div class="page-content">
		<form class="form-horizontal" action="/contact" method="POST">
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="AddressLine" name="AddressLine" maxlength="128" placeholder="Enter AddressLine">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="AddressLine1" name="AddressLine1" maxlength="128" placeholder="Enter AddressLine1">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="AlternatePhone" name="AlternatePhone" maxlength="32" placeholder="Enter AlternatePhone">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="datepicker form-control" id="BulkEmailOptOutTime" name="BulkEmailOptOutTime" data-provide="datepicker" placeholder="Enter BulkEmailOptOutTime">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="City" name="City" maxlength="32" placeholder="Enter City">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
                            <select class="form-control" id="CompanyLocationID" name="CompanyLocationID">
                                <option value=""></option>
                            </select>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="EMailAddress" name="EMailAddress" maxlength="50" placeholder="Enter EMailAddress">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="EMailAddress2" name="EMailAddress2" maxlength="50" placeholder="Enter EMailAddress2">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="EMailAddress3" name="EMailAddress3" maxlength="50" placeholder="Enter EMailAddress3">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="Extension" name="Extension" maxlength="10" placeholder="Enter Extension">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="FacebookUrl" name="FacebookUrl" maxlength="200" placeholder="Enter FacebookUrl">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="FaxNumber" name="FaxNumber" maxlength="25" placeholder="Enter FaxNumber">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="FirstName" name="FirstName" maxlength="20" placeholder="Enter FirstName" required>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="IsOptedOutFromBulkEmail" name="IsOptedOutFromBulkEmail">
								<option value=""></option>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="datepicker form-control" id="LastModifiedDate" name="LastModifiedDate" data-provide="datepicker" placeholder="Enter LastModifiedDate">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="LastName" name="LastName" maxlength="20" placeholder="Enter LastName" required>
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="LinkedInUrl" name="LinkedInUrl" maxlength="200" placeholder="Enter LinkedInUrl">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="MiddleInitial" name="MiddleInitial" maxlength="50" placeholder="Enter MiddleInitial">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="MobilePhone" name="MobilePhone"	maxlength="25" placeholder="Enter MobilePhone">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="Note" name="Note" maxlength="50" placeholder="Enter Note">
						</div>
					</div>
				</div>
				<div class="col-6">
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="PrimaryContact" name="PrimaryContact">
								<option value=""></option>
								<option value="True" title="Yes">Yes</option>
								<option value="False" title="No">No</option>
							</select>
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="ReceivesEmailNotifications" name="ReceivesEmailNotifications">
								<option value=""></option>
								<option value="True" title="Yes">Yes</option>
								<option value="False" title="No">No</option>
							</select>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="RoomNumber" name="RoomNumber" maxlength="50" placeholder="Enter RoomNumber">
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="SolicitationOptOut" name="SolicitationOptOut">
								<option value=""></option>
								<option value="True" title="Yes">Yes</option>
								<option value="False" title="No">No</option>
							</select>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="datepicker form-control" id="SolicitationOptOutTime" name="SolicitationOptOutTime" data-provide="datepicker" placeholder="Enter SolicitationOptOutTime">
						</div>
					</div>
				</div>
				<div class="col-6">
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="SurveyOptOut" name="SurveyOptOut">
								<option value=""></option>
								<option value="True" title="Yes">Yes</option>
								<option value="False" title="No">No</option>
							</select>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="TwitterUrl" name="TwitterUrl" maxlength="200" placeholder="Enter TwitterUrl">
						</div>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-12">
				  	<input type="text" class="form-control" id="ZipCode" name="ZipCode" maxlength="16" placeholder="Enter ZipCode">
				</div>
			</div>
			<div class="form-group">
