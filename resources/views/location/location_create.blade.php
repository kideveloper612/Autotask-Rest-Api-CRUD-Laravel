...
@section('content')
    <div class="page-content">
		<form class="form-horizontal" action="/location" method="POST">
			@csrf
			<div class="row">
				<div class="col-6">
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="Description" name="Description" maxlength="500" placeholder="Enter Description">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="text" class="form-control" id="Name" name="Name" maxlength="100" placeholder="Enter Name" required>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control" id="OverrideCompanyTaxSettings" name="OverrideCompanyTaxSettings">
								<option value=""></option>
								<option value="True" title="Yes">Yes</option>
								<option value="False" title="No">No</option>
							</select>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group">
						...
						<div class="col-sm-12">
						  	<input type="number" class="form-control" id="RoundtripDistance" name="RoundtripDistance" placeholder="Enter RoundtripDistance">
						</div>
					</div>
				</div>
			</div>
